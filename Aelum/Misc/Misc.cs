...
static class MathUtils
{
   ...
   public static RectF AABBFromCorners(Vector3 corner0, Vector3 corner1, Vector3 corner2, Vector3 corner3)
   {
      float minX = Min(corner0.X, corner1.X, corner2.X, corner3.X);
      float maxX = Max(corner0.X, corner1.X, corner2.X, corner3.X);
      float minY = Min(corner0.Y, corner1.Y, corner2.Y, corner3.Y);
      float maxY = Max(corner0.Y, corner1.Y, corner2.Y, corner3.Y);
